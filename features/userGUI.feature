...
Scenario: Cadastro de Usuário com Sucesso
    ...
    And eu preencho o campo de nome com "Davi Guerreiro"
    And eu preencho o campo de data de nascimento com "16/12/2024"
    And eu preencho o campo de login com "fizz"
    And eu preencho o campo de e-mail com "dggb@cin.ufpe.br"
    And eu preencho o campo de senha com "senha456"
...
Scenario: Falha no Cadastro de Usuário por Falta de Dados Obrigatórios
    ...
    And eu preencho o campo de login com "fizz"
    And eu preencho o campo de senha com "senha456"
    When eu preencho o campo de e-mail com ""
...
Scenario: Atualização de Cadastro de Usuário com Sucesso
    ...
    And eu preencho o campo de login com "javamelhorquec"
...
Scenario: Falha na Atualização de Cadastro de Usuário por Campo Vazio
    ...
    And eu preencho o campo de login com ""
    When eu seleciono "Confirmar"
...
Scenario: Atualização de Senha de Usuário com Sucesso
    ...
    And eu preencho o campo de senha atual com "12345678"
    And eu preencho o campo de nova senha com "senha123"
    And eu preencho o campo de confirmar senha com "senha123"
...
Scenario: Falha na Atualização de Senha de Usuário por Senha Insuficiente
    ...
    And eu estou na página "Alterar Senha"
    And eu preencho o campo de senha atual com "12345678"
    And eu preencho o campo de nova senha com "123"
    And eu preencho o campo de confirmar senha com "123"
    When eu seleciono "Alterar"
...
Scenario: Falha na Atualização de Senha de Usuário por Senha Atual Incorreta
    Given estou autenticado como o usuário de login "javeiro" e senha "12345678"
    And eu estou na página "Alterar Senha"
    And eu preencho o campo de senha atual com "123456"
    And eu preencho o campo de nova senha com "senha123"
    And eu preencho o campo de confirmar senha com "senha123"
    When eu seleciono "Alterar"
...
Scenario: Falha na Atualização de Senha de Usuário por Senhas Diferentes
    ...
    And eu preencho o campo de senha atual com "12345678"
    And eu preencho o campo de nova senha com "senha123"
    And eu preencho o campo de confirmar senha com "senha123456"
    When eu seleciono "Alterar"
