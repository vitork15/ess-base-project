...
Scenario: Compartilhar playlist da biblioteca
    Given usuário de ID "16" esta autenticado no sistema
...
Scenario: Compartilhamento de música inexistente
    Given Usuário de ID "20" e nome "Rodrigo" esta autenticado no sistema
...
Scenario: Compartilhamento de música inexistente
    Given Usuário de ID "20" e nome "Alex" esta autenticado no sistema
    And Usuário quer compartilhar uma Música com ID "27" e nome "A raposa e as uvas"
